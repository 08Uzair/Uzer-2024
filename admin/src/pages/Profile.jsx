      ...
      <div className="p-16">
        <div className="p-8 bg-white shadow mt-24">
          <div className="grid grid-cols-1 md:grid-cols-3">
            ...
            <div>
              <div className="w-48 h-48 bg-indigo-100 mx-auto rounded-full shadow-2xl absolute inset-x-0 top-0 left-48 mt-12 flex items-center justify-center text-indigo-500">
                {userData?.avatar ? (
                  <img
            ...
            <div className="space-y-8 mt-20 md:mt-0"></div>
          </div>
