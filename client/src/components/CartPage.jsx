...
const CartItems = () => {
  ...
  useEffect(() => {
    if (cartProducts) {
      ...
      // Initialize quantities state with 1 for each product
          ...
          <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
            ...
            <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
              ...
              <div className="flex items-center space-x-4">
                {/* particular product (price * quanity) */}
                <p className="text-sm">
...
const Subtotal = ({ products, quantities }) => {
  ...
  const price = (subtotalPrice + 50).toFixed(2);
  return (
